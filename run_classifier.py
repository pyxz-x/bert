...
def convert_examples_to_features(examples, label_list, max_seq_length,
  ...
  return features
# cyyProcessor
class cyyProcessor(DataProcessor):
    ...
    def get_labels(self):#这里返回了数据样本中定义标签枚举
        """See base class."""
        return [
  "产品原因（包括说明书等）",
  "产品原因（包括说明书等）,操作原因",
  "产品原因（包括说明书等）,操作原因,无法确定",
  "产品原因（包括说明书等）,无法确定",
  "产品原因（包括说明书等）,无法确定,操作原因",
  "医院_事件原因分析",
  "患者自身原因",
  "患者自身原因,操作原因",
  "操作原因",
  "操作原因,产品原因（包括说明书等）",
  "操作原因,产品原因（包括说明书等）,无法确定",
  "操作原因,无法确定",
  "无法确定",
  "无法确定,产品原因（包括说明书等）",
  "无法确定,产品原因（包括说明书等）,操作原因",
  "无法确定,患者自身原因",
  "无法确定,操作原因"
]
